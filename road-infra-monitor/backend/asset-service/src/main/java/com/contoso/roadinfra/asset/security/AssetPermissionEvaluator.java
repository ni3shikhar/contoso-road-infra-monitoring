...
/**
 * Custom permission evaluator for asset-service that reads user roles from JWT claims
 * and checks permissions using the RolePermissionMapping.
 */
@Component("permissionEvaluator")
@Slf4j
public class AssetPermissionEvaluator {
     ...
     * Roles are stored in authorities with prefix "ROLE_".
     */
    private Set<Role> extractRolesFromAuthentication(Authentication authentication) {
        ...
        // Fallback: try to extract from authentication authorities directly
     ...
     * Note: With stateless JWT, user ID is the same as username.
     */
